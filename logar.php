    ...
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5 mt-0">
        <form action="controllers/controller_usuario.php" method="post" class="p-4 p-md-5 border rounded-3 ">
          ...
          <button class="w-100 btn btn-md btn-primary" type="submit" name="botao" id="botao" value="Logar">Entrar</button>
          <hr>
          <a class="btn btn-link ps-5 ms-5 mt-1 " href="./esqueci_senha.php" role="button">Esqueci Senha</a><br>
          <?php
